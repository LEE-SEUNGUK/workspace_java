...
public class OperatorMain {
	...
	public static void main(String[] args) {
		...
		String message = (len > 10) ? "사용 가능합니다." : "10자리 이상으로 다시 작성해주세요.";
		...
		int ldLen = userInput2.length();
		String message2 = (ldLen >= 8 && ldLen < 15) ? "사용 가능합니다." : "8 ~ 14자리 사이로 다시 작성해주세요.";
